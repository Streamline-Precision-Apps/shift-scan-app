...
export default function PayrollQrLandingPage() {
  return (
    <main className="relative min-h-screen max-h-screen overflow-hidden bg-linear-to-br from-app-dark-blue via-app-blue to-app-blue px-2 md:px-8 py-0 flex flex-col items-center justify-center">
